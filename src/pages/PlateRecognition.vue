    ...
    <div class="min-h-screen w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
      <div class="bg-teal-500 text-white p-4 flex items-center relative fixed top-0 z-50">
        ...
        <div class="grid grid-cols-3 w-full">
          ...
          <!-- Plate Recognition dropdown button -->
          <div class="flex items-center justify-center relative">
            <div class="relative flex items-center">
              <button @click="toggleDropdown" class="flex items-center focus:outline-none px-2 py-1 hover:bg-teal-600 rounded-lg transition-colors duration-300">
                <span class="text-2xl font-bold">Plate Recognition</span>
        ...
        <ul class="space-y-4">
          <li v-for="(chat, index) in chats" :key="index">
            <div v-if="chat.message" class="chat-item right-align">
              <div class="bg-purple-300 inline-block p-3 rounded-lg max-w-2xl left-align break-words">
      ...
      <div class="p-4 border-t border-gray-200 flex items-center">
        <textarea
          ...
          v-model="newMessage"
          placeholder="Copy and paste your image URL or base 64 encoded image..."
...
const sendMessage = async () => {
  ...
  try {
    const response = await axios.post('/api/plate-recognition/', {
      message,
    }, {
      headers: {
